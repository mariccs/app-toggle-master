...
# em vez do endpoint real da AWS. Se não definido, o comportamento original
# (AWS real) é mantido. O SQS continua sempre apontando para a AWS real, pois
# o docker-compose deste desafio não inclui um mock de SQS.
...
try:
    ...
    if DYNAMODB_ENDPOINT_URL:
        log.info(f"DynamoDB client apontando para endpoint local: {DYNAMODB_ENDPOINT_URL}")
